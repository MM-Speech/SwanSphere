...
from modules.foa_vae.wavvae_v3 import build_foa_wavvae_v3, trainable_param_report
...
class FOAWavVAEV3Task(FastDatasetMixin, BaseTask):
    def __init__(self):
        super().__init__()
    ...
    def build_model(self):
        ...
        self.model_gen = build_foa_wavvae_v3(hparams=hparams, init_pretrained=init_pretrained)
